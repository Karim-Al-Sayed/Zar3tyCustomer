...
public class Items {
    ...
    public Items(String description, String price, String title, String category, String maincategory, String quantity, String id, String date, String date_to_show, String img_uri) {
