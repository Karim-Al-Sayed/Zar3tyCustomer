...
public class UpdateUserData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mStorage = FirebaseStorage.getInstance().getReference("ProfileImages").child("Customers");
        UsersRef = FirebaseDatabase.getInstance().getReference("Users").child("Customers");
