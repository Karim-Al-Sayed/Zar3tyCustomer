 ...
 * {@link IrrigationItems.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link IrrigationItems#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IrrigationItems extends Fragment {
    ...
    //-----------------------------------------------
    @BindView(R.id.irrigation_recycler_frag)
    RecyclerView recyclerView;
    //-----------------------------------------------
    public IrrigationItems() {
    ...
    public static IrrigationItems newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.irrigation_items_frag, container, false);
        context = getActivity();
        ...
        Sales_Ref.child("Irrigation").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                IrrigationItemsAdapter adapter = new IrrigationItemsAdapter(itemslist,getActivity());
