...
import com.elasdka2.zar3tycustomer.FavoriteItemInfo;
...
public class FavoritesItemsAdapter extends RecyclerView.Adapter<FavoritesItemsAdapter.MyViewHolder> {
    ...
    public FavoritesItemsAdapter(ArrayList<Items> itemlist, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.Card_Item.setOnClickListener(v -> {
            ...
            args.putString("UniqueID","from_FavoriteItemsAdapter");
