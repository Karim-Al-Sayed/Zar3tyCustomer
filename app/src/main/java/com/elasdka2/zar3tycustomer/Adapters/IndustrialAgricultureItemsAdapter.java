...
public class IndustrialAgricultureItemsAdapter extends RecyclerView.Adapter<IndustrialAgricultureItemsAdapter.MyViewHolder> {
    ...
    public IndustrialAgricultureItemsAdapter(ArrayList<Items> itemlist, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.Card_Item.setOnClickListener(v -> {
            ...
            args.putString("UniqueID","from_IndustrialAgricultureItemsAdapter");
