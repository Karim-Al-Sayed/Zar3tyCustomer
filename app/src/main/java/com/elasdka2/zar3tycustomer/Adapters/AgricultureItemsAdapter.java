...
public class AgricultureItemsAdapter extends RecyclerView.Adapter<AgricultureItemsAdapter.MyViewHolder> {
    ...
    public AgricultureItemsAdapter(ArrayList<Items> itemlist, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.Card_Item.setOnClickListener(v -> {
            ...
            args.putString("UniqueID","from_AgricultureItemsAdapter");
        ...
        holder.fav_Img.setOnClickListener(v -> {
            ...
            favMap.put("Img_Uri", itemsList.get(position).getImg_uri());
            favMap.put("Item_Price", holder.Item_Price.getText().toString());
