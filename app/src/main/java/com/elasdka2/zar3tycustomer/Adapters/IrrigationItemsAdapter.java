...
public class IrrigationItemsAdapter extends RecyclerView.Adapter<IrrigationItemsAdapter.MyViewHolder> {
    ...
    public IrrigationItemsAdapter(ArrayList<Items> itemlist, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.Card_Item.setOnClickListener(v -> {
            ...
            args.putString("UniqueID","from_IrrigationItemsAdapter");
