...
import com.elasdka2.zar3tycustomer.Adapters.IndustrialAgricultureItemsAdapter;
 ...
 * {@link IndustrialAgricultureItems.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link IndustrialAgricultureItems#newInstance} factory method to
 * create an instance of this fragment.
 */
public class IndustrialAgricultureItems extends Fragment {
    ...
    //-----------------------------------------------
    @BindView(R.id.industrial_agriculture_recycler_frag)
    RecyclerView recyclerView;
    //-----------------------------------------------
    public IndustrialAgricultureItems() {
    ...
    public static IndustrialAgricultureItems newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.industrial_agriculture_items_frag, container, false);
        context = getActivity();
        ...
        Sales_Ref.child("Industrial_Agriculture").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                IndustrialAgricultureItemsAdapter adapter = new IndustrialAgricultureItemsAdapter(itemslist,getActivity());
